...
Date:- 02-06-2024 
Code No:- 9
Code:- Create Log File and display its time of creation and display information of all running processes in it. Schedule this activity after every 1 minutes. Create Folder and create log File in it for each minute.
# Not Working
"""
import psutil
import time
