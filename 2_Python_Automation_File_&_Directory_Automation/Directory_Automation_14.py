...
Date:- 26-05-2024
Code No:- 17
Code:- Take Directory name from user and search file with given extension and display all those files and Delete those Extension's Files. Here extension name can also be case insensitive.
"""
import os
import sys
import time
