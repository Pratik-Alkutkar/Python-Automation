...
Date:- 26-05-2024
Code No:- 8
Code:- Return all the files present in given directory's Folder that is given in Command Line arguments. Final Version. Focusing on For Loop.
"""
import os
import sys
import time
    ...
    if (exist == True):
        for foldername, subfoldername, filename in os.walk(DirName):
            ...
            for subname in subfoldername:
                print("Sub Folder name is: ", subfoldername)
